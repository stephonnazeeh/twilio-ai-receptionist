...
# Set your OpenAI key (Render will store this as an env variable)
...
def voice():
    ...
    # Try to dial your cell (via Google Voice forwarding) for 6 seconds
    dial = resp.dial(timeout=6)
    dial.number("+1-323-457-6314")

    # If not answered, AI steps in
